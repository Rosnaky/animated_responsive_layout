            ...
            child: Column(
              ...
              children: [
                if (widget.showHeadline) ...[
                  EmailHeadline(
                      email: widget.email, isSelected: widget.isSelected)
                ],
                EmailContent(
                    email: widget.email,
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        LayoutBuilder(builder: (context, constraints) {
          return Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            if (constraints.maxWidth > 200) ...[const StarButton()]
          ]);
        }),
        const SizedBox(
          height: 8,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('${widget.email.replies.toString()} Messages',
                            maxLines: 1,
                            overflow: TextOverflow.fade,
                            style: _textTheme.bodyMedium
